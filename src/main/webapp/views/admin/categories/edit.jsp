...
<header class="row">
	...
	<div class="container">
		...
		<div class="row">
			<div class="card">
				...
				<div class="col-md-12 ">
					<form:form
						action="/IT16308_Assignment/admin/categories/update/${item.id }"
						...
						<div class="form-input m-3">
							...
							<a href="/IT16308_Assignment/admin/categories/create"
								class="btn btn-success ">Tạo danh mục</a>
						</div>
					</form:form>
				</div>
				<div class="col-md-12">
							...
							<c:forEach items="${data.content }" var="cate">
								<tr>
									...
									<td><a class="btn btn-primary"
										href="/IT16308_Assignment/admin/categories/edit/${cate.id }">Edit</a>
									</td>
									<td><button type="button" class="btn btn-danger"
											data-bs-toggle="modal" data-bs-target="#p${cate.id}">Xóa</button>
										<!-- Modal -->
												...
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a class="btn btn-danger"
															href="/IT16308_Assignment/admin/categories/delete/${ cate.id }">Xóa</a>
													</div>
												</div>
											</div>
										</div></td>
	...
	<script src="/IT16308_Assignment/js/bootstrap.min.css"></script>
	<script src="/IT16308_Assignment/js/jquery.min.css"></script>
	<script src="/IT16308_Assignment/js/popper.min.css"></script>
</body>
</html>