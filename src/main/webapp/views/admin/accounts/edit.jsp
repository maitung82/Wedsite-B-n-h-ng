	...
	<div class="container">
		...
		<div class="row">
			<div class="card">
				...
				<div class="col-md-12 ">
					<form:form
						action="/IT16308_Assignment/admin/accounts/update/${item.id }"
						modelAttribute="account" method="POST">
						<div class="form-input">
							<label class="form-label">Username :</label>
							<form:input path="username" value="${item.username }"
								class="form-control" />
								<form:errors path="username" class="text-danger"></form:errors>
						</div>
						<div class="form-input">
							<label class="form-label">Password :</label>
							<form:input path="password" value="${item.password }"
								class="form-control" />
								
						</div>
						<div class="form-input">
							<label class="form-label">Fullname :</label>
							<form:input path="fullname" value="${item.fullname }"
								class="form-control" />
								<form:errors path="fullname" class="text-danger"></form:errors>
						</div>
						<div class="form-input">
							<label class="form-label">Email :</label>
							<form:input path="email" value="${item.email }" type="email"
								class="form-control" />
								<form:errors path="email" class="text-danger"></form:errors>
						</div>
						<div class="form-input">
							<label class="form-label">Photo :</label>
							<form:input path="photo" type="file" value="${item.photo }"
								class="form-control" />
						...
						<div class="form-input">
							<label>Role :</label>
							<form:select path="admin" value="${item.admin }"
								class="form-select">
						...
						<div class="form-input m-3">
							...
							<a href="/IT16308_Assignment/admin/accounts/create"
								class="btn btn-success ">Tạo người dùng</a>
						</div>
					</form:form>
				</div>
				<div class="col-md-12">
						...
						<tbody>
							<c:forEach items="${data.content }" var="acc">
								<tr>
									...
									<td>${ acc.email }</td>
									<td>
										<img  src="${ acc.photo }" style="width: 200px ; height: 120px">
									</td>
									<td>
										<c:choose>
									...
									<td><a class="btn btn-primary"
										href="/IT16308_Assignment/admin/accounts/edit/${acc.id }">Edit</a>
									</td>
									<td><button type="button" class="btn btn-danger"
											data-bs-toggle="modal" data-bs-target="#p${acc.id}">Xóa</button>
										<!-- Modal -->
												...
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a class="btn btn-danger"
															href="/IT16308_Assignment/admin/accounts/delete/${ acc.id }">Xóa</a>
													</div>
												</div>
											</div>
										</div></td>
