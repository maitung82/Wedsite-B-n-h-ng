	...
	<nav class="navbar navbar-expand-lg c shadow navbar-light bg-white">
		...
		<div class="row">
			<div class="card">
				...
				<div class="col-md-12">
					<form:form
						action="/IT16308_Assignment/admin/products/store"
						...
						<div class="form-input">
							...
							<form:input path="created_date" type="date"   class="form-control" />
						</div>
						<div class="form-input">
							<label class="form-label"> Avaliable :</label>
							<form:radiobuttons name="available" path="available" items="${available }" label="Avaliable"/>
						</div>
						<div class="form-input">
							<label>Category</label>
							<form:select path="category_id" class="form-select">
